...
var InitMap = function() {
  var initPoint = {lat: 47.60, lng: -122.36}
...
var CreateInfoWindow = function(feature) {
    ...
    if(pcoInfo) {
      ...
      pcoContent = pcoContent + '<p> No PCO currently.</p>' + 
        '<a href="http://37dems.org/index.php?page=display&id=130"> Click here to be appointed!</a>';
    }
...
function precincts_callback(response) {
  globals.GetMap().data.addGeoJson(response);
}
